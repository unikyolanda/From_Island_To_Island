    ...
    <div class="flex flex-col items-end p-12 text-white">
      ...
      <nav class="flex flex-col items-end space-y-12 w-full">
        <div class="flex justify-between w-full items-center">
          ...
          <div class="flex flex-col items-start space-y-5 w-1/2">
        ...
        <div class="flex flex-col items-end">
          <p class="font-noto text-2xl tracking-[4px]">聯絡我們</p>
          <p class="font-amiri italic text-lg">CONTACT</p>
        </div>
        <div class="flex flex-col items-end space-y-4">
          <a href="#" class="font-noto tracking-[2px]">捐款支持</a>
        </div>
      </nav>
    </div>
  </div>
