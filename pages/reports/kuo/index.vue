...
<template>
  <div class="flex flex-col bg-black w-screen h-auto min-h-screen items-center">
    ...
    <div class="w-[1116px] relative flex flex-col items-center">
      ...
      <img src="/images/reports/popbox/popbox_2_1.png" class="w-screen h-auto" />
      ...
      <div class="flex gap-x-16 my-16">
        ...
        <div class="flex flex-col h-full justify-center gap-y-2 mt-2">
      ...
      <p class="font-noto tracking-[2px] text-white w-[841px] text-justify leading-[36px]">
        <span class="font-semibold">《由島至島》紀錄片映演計畫——屏東場</span><br /><br />
      ...
      <div class="flex gap-x-4 my-12">
        <img src="/images/reports/popbox/popbox_2_2.png" class="w-[412px] h-auto" />
        <img src="/images/reports/popbox/popbox_2_3.png" class="w-[412px] h-auto" />
      </div>
      <p class="font-noto tracking-[2px] text-white w-[841px] text-justify leading-[36px]">
      ...
      <div class="flex gap-x-4 my-12">
        <img src="/images/reports/popbox/popbox_2_4.png" class="w-[412px] h-auto" />
        <img src="/images/reports/popbox/popbox_2_5.png" class="w-[412px] h-auto" />
      </div>
      <p class="font-noto tracking-[2px] text-white w-[841px] text-justify leading-[36px]">
      ...
      <div class="flex gap-x-4 my-12">
        <img src="/images/reports/popbox/popbox_2_6.png" class="w-[412px] h-auto" />
        <img src="/images/reports/popbox/popbox_2_7.png" class="w-[412px] h-auto" />
      </div>
      <p class="font-noto tracking-[2px] text-white w-[841px] text-justify leading-[36px]">
      ...
      <img src="/images/reports/popbox/popbox_2_8.png" class="w-screen h-auto mt-12 mb-[97px]" />
    </div>
  </div>
</template>
