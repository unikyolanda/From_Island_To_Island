    ...
    <div class="w-full sm:w-[1116px] relative flex flex-col items-center">
      ...
      <div class="flex gap-x-4 my-12">
        <img
          ...
          class="w-[295px] sm:w-[412px] h-auto"
        />
        <img
      ...
      <img
        src="/images-webp/reports/popbox/Popbox_1_5.webp"
        class="sm:hidden block w-[295px] sm:w-[412px] h-auto mt-8"
      />
      <p
        class="font-noto tracking-[0.5px] sm:tracking-[2px] text-white w-[295px] sm:w-[841px] text-[14px] sm:text-[16px] text-justify leading-[30px] sm:leading-[36px] mt-8"
      >
