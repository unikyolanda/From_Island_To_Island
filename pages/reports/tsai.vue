...
<template>
  <div class="flex flex-col bg-black w-screen h-auto min-h-screen items-center">
    ...
    <div class="w-[1116px] relative flex flex-col items-center">
      ...
      <img src="/images-webp/reports/popbox/Popbox_1_1.webp" class="w-screen h-auto" />
      <div class="flex items-center gap-x-12 my-16 w-[841px]">
        <img
      ...
      <div class="flex gap-x-4 my-12">
        <img src="/images-webp/reports/popbox/Popbox_1_2.webp" class="w-[412px] h-auto" />
        <img src="/images-webp/reports/popbox/Popbox_1_3.webp" class="w-[412px] h-auto" />
      </div>
      <p class="font-noto tracking-[2px] text-white w-[841px] text-justify leading-[36px]">
      ...
      <div class="flex gap-x-4 my-12">
        <img src="/images-webp/reports/popbox/Popbox_1_4.webp" class="w-[412px] h-auto" />
        <img src="/images-webp/reports/popbox/Popbox_1_5.webp" class="w-[412px] h-auto" />
      </div>
      <p class="font-noto tracking-[2px] text-white w-[841px] text-justify leading-[36px]">
