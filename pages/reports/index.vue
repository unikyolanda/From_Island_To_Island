...
<template>
  <div class="flex flex-col bg-black w-screen h-auto min-h-screen items-center">
    ...
    <div class="flex flex-col w-full z-10 items-center opacity-80">
      <div class="flex w-full px-[184px] pt-[233px] justify-between items-end mt-10">
        <div class="flex flex-col">
          <p class="font-amiri italic text-white tracking-[2px] text-lg sm:text-[28px]">
            Discussion & Reports
          </p>
    ...
    <div class="flex mt-[73px] w-full justify-between px-[184px] z-10 opacity-85">
      ...
      <div class="flex flex-col w-[710px] gap-y-10">
    ...
    <div class="flex mt-[73px] w-full justify-between px-[184px] z-10 opacity-90">
      ...
      <div class="flex flex-col mt-[150px] gap-y-8">
        <div class="flex flex-col">
          ...
          <a
            ...
            class="font-noto text-[16px] font-light underline underline-offset-4 text-white/80 hover:text-white tracking-[2px]"
          >
    ...
    <div class="w-full z-10 opacity-80 flex pt-[97px] justify-between px-[184px] bg-audience">
      ...
      <div class="flex flex-col mt-[60px] gap-y-14">
        <div class="flex flex-col w-[710px] gap-y-7 border-b border-white pb-14">
          <div class="font-noto text-[20px] font-semibold text-white tracking-[2px] leading-[36px]">
            張世倫<span class="text-[14px]">／攝影史研究者，藝評家</span>
          </div>
          <p
            class="font-noto text-[14.5px] font-light text-white tracking-[0.5px] leading-[30px] text-justify"
          >
        ...
        <div class="flex flex-col w-[710px] gap-y-7 border-b border-white pb-14">
          <div class="font-noto text-[20px] font-semibold text-white tracking-[2px] leading-[36px]">
            藤岡朝子<span class="text-[14px]">／山形國際紀錄片影展理事、前山形影展選片人</span>
          </div>
          <p
            class="font-noto text-[14.5px] font-light text-white tracking-[0.5px] leading-[30px] text-justify"
          >
          ...
          <p
            class="font-noto text-[14px] font-light text-white tracking-[0.5px] leading-[30px] text-justify"
          >
        ...
        <div class="flex flex-col w-[710px] gap-y-7 border-b border-white pb-14">
          <div class="font-noto text-[20px] font-semibold text-white tracking-[2px] leading-[36px]">
            吳牧青<span class="text-[14px]">／藝評人</span>
          </div>
          <p
            class="font-noto text-[14.5px] font-light text-white tracking-[0.5px] leading-[30px] text-justify"
          >
        ...
        <div class="flex flex-col w-[710px] gap-y-7 border-b border-white pb-14">
          <div class="font-noto text-[20px] font-semibold text-white tracking-[2px] leading-[36px]">
            台灣觀眾<span class="text-[14px]">／35 歲、服務業者</span>
          </div>
          <p
            class="font-noto text-[14.5px] font-light text-white tracking-[0.5px] leading-[30px] text-justify"
          >
        ...
        <div class="flex flex-col w-[710px] gap-y-7 pb-14">
          <div class="font-noto text-[20px] font-semibold text-white tracking-[2px] leading-[36px]">
            馬來西亞麻坡觀眾<span class="text-[14px]">／36 歲、家管</span>
          </div>
          <p
            class="font-noto text-[14.5px] font-light text-white tracking-[0.5px] leading-[30px] text-justify"
          >
