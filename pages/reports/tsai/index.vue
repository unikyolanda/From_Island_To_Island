...
<template>
  <div class="flex flex-col bg-black w-screen h-auto min-h-screen items-center">
    ...
    <div class="w-[1116px] relative flex flex-col items-center">
      ...
      <img src="/images/reports/popbox/Popbox_1_1.jpg" class="w-screen h-auto" />
      ...
      <p class="font-noto tracking-[2px] text-white w-[841px] text-justify leading-[36px]">
        <span class="font-semibold">《由島至島》紀錄片映演計畫——嘉義場</span><br /><br />
      ...
      <div class="flex gap-x-4 my-12">
        <img src="/images/reports/popbox/Popbox_1_2.jpg" class="w-[412px] h-auto" />
        <img src="/images/reports/popbox/Popbox_1_3.jpg" class="w-[412px] h-auto" />
      </div>
      <p class="font-noto tracking-[2px] text-white w-[841px] text-justify leading-[36px]">
      ...
      <div class="flex gap-x-4 my-12">
        <img src="/images/reports/popbox/Popbox_1_4.jpg" class="w-[412px] h-auto" />
        <img src="/images/reports/popbox/Popbox_1_5.jpg" class="w-[412px] h-auto" />
      </div>
      <p class="font-noto tracking-[2px] text-white w-[841px] text-justify leading-[36px]">
        「家中長輩不願談這段歷史，我們也難以進一步得知。」觀眾提問，導演接續回應「如同我父親未提及日治時期的記憶。片中許多人不願談、沒有勇氣講、不知道如何說，但要知道我們都是隔了一個歷史時空，從冷靜的狀態回顧當時，才可以這麼談。如果回到那個當下，我們真的能多說什麼或多做什麼嗎？」《九槍》密錄器拍攝的畫面裡，可以看到周遭的警察與民眾沒有做任何事，觀眾常常提問為何不作為，但當導演反問「如果在同樣時空，你會怎麼做？」觀眾通常都愣住了，無法確定到底可不可以做出不同決定。「我們沒有辦法站在道德制高點去批判這些人，但我們一定要透過這樣的人民記憶去建構、去記得這些事，現在我們知道了，我們這一代可以做什麼，下一代做什麼，和前面那些世代是不一樣的，這個是重要的。」。<br /><br />
      ...
      <img src="/images/reports/popbox/Popbox_1_6.jpg" class="w-screen h-auto mt-12 mb-[205px]" />
    </div>
  </div>
</template>
